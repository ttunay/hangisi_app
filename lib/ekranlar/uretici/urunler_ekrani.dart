...
class _UrunlerEkraniState extends State<UrunlerEkrani> {
  ...
  final List<Color> _temaRenkleri = [
    const Color.fromARGB(255, 250, 245, 197), const Color.fromARGB(255, 243, 204, 203), 
    const Color.fromARGB(255, 226, 194, 164), const Color.fromARGB(255, 205, 233, 182), 
    const Color.fromARGB(255, 188, 209, 233), const Color.fromARGB(255, 182, 236, 232),
  ];
  ...
  void _urunDetayPaneli(String id, Map<String, dynamic> urun, Color kartRengi) {
    ...
    showModalBottomSheet(
      ...
      backgroundColor: Colors.white, //PANEL RENGİİİİİİİİİİİİİİİİİİİİİİİİİİİİİİİ
        ...
        builder: (context, scrollController) => SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              Text("Barkod: ${urun['barkod'] ?? '-'}", style: const TextStyle(color: Colors.black87, fontWeight: FontWeight.w500)),
              ...
              SizedBox(height: birim * 0.08), // İLAÇLAMA İLE DÜZENLE BUTON BOŞLUĞUUUUUUUUUUUUUUUUUUUUUU
              Row(
                children: [
        ...
        children: [
          ...
          Expanded(
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text(baslik, style: TextStyle(color: const Color.fromARGB(255, 0, 0, 0), fontSize: birim * 0.045, fontWeight: FontWeight.w500)),
                Text(
                  icerik, 
      ...
      builder: (context) => Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            TextField(controller: barkodEdit, decoration: InputDecoration(labelText: "Barkod", border: OutlineInputBorder(borderRadius: BorderRadius.circular(15)))),
            const SizedBox(height: 15),
            ...
            ElevatedButton(
              style: ElevatedButton.styleFrom(backgroundColor: const Color(0xFF1E201C), minimumSize: const Size(double.infinity, 60), shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(30))),
              onPressed: () async {
              ...
              child: const Text("Değişiklikleri Kaydet", style: TextStyle(color: Color.fromARGB(255, 255, 255, 255), fontSize: 16)),
            ),
            ...
            builder: (context, userSnapshot) {
              ...
              return SafeArea(
                child: CustomScrollView(
                  physics: const AlwaysScrollableScrollPhysics(), // Her durumda kaydırmayı aktif tut
                  slivers: [
                    // --- ÜST KISIM (Sabit Elemanlar) ---
                    SliverToBoxAdapter(
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          ...
                          Padding(
                            padding: EdgeInsets.symmetric(horizontal: birim * 0.06, vertical: birim * 0.02),
                            child: Text("Ürünlerim", style: TextStyle(fontSize: birim * 0.055, fontWeight: FontWeight.bold, color: Colors.black87))
                          ),
                        ],
                      ),
                    ),

                    // --- LİSTE KISMI (StreamBuilder Sliver İçinde) ---
                          ...
                          return SliverToBoxAdapter(
                            child: Center(
                              child: Padding(
                                ...
                                child: Text("Henüz ürün yok.", style: TextStyle(color: Colors.black54, fontSize: birim * 0.04)),
                              )
                            )
                          );
                        }

                        // ListView.builder yerine SliverList kullanıyoruz
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  Text(
                    urun['urunAdi'] ?? "", 
                    style: TextStyle(fontSize: birim * 0.05, fontWeight: FontWeight.w900, color: const Color(0xFF1E201C)),
                    maxLines: 1,
                  ...
                  Text(
                    urun['aciklama'] ?? "", 
                    style: TextStyle(color: const Color.fromARGB(255, 43, 43, 43), fontSize: birim * 0.04, height: 1.2), 
                    maxLines: 2, 
                    overflow: TextOverflow.ellipsis
                  ), 
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(color: kartRengi.withOpacity(0.15), borderRadius: BorderRadius.circular(8)), 
                    child: Text("Barkod: ${urun['barkod'] ?? '-'}", style: TextStyle(fontSize: birim * 0.030, fontWeight: FontWeight.bold, color: kartRengi))
                  )
                ]
              )
            ),
